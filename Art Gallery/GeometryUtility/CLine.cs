...
By: Holden Easley
Because I kick some serious ass
* *** **********************************************/
...
namespace GeometryUtility
{
	...
	public class CLineSegment : CLine
	{
		...
		*********************************************************/
        ...
        /********************************************************
         * Returns intersection point if it exists, otherwise null
         * *******************************************************/
        public CPoint2D IntersectionPoint(CLineSegment line)
        {
            if (IntersectedWith(line))
            {
                double x1 = this.m_startPoint.X;
                double y1 = this.m_startPoint.Y;
                double x2 = this.m_endPoint.X;
